...
class MainPageContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const MainPageContentContent();
  }
}

class MainPageContentContent extends StatefulWidget {
  const MainPageContentContent({super.key});

  @override
  State<MainPageContentContent> createState() => _MainPageContentContentState();
}

class _MainPageContentContentState extends State<MainPageContentContent> {
  AppBar appBar() {
    return AppBar(
